...
<head>
    ...
    <title>Al Minhaj - Pesan Terkirim</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">Pesan Terkirim</h1>
                        <a href="/kirim_pesan" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="font-size: 12pt;"><i class="fas fa-download fa-envelope text-white-100"></i> Tulis Pesan</a>
                    </div>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        @foreach($outbox as $key=>$value)
                        <a href="{{route('outbox_detail', ['id' => $value->id])}}">
                            <div class="message">
                                <span class="sender">{{$value->penerima}}</span>
