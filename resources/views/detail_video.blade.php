        ...
        <div id="fh5co-page">
            ...
            <div id="fh5co-feature-product" class="fh5co-section-gray">
                ...
                <div class="container">
                    ...
                    <div class="container_iframe" style="margin-bottom: 2em;">
                        <iframe class="responsive-iframe" src="https://www.youtube.com/embed/{{\Illuminate\Support\Str::substr($value->link, 17)}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <a href="{{route('edit_mengaji', ['id' => $value->id])}}" class="btn btn-primary btn-lg">Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{ route('hapus_mengaji', ['id' => $value->id]) }}">Iya</a>
                </div>
            </div>
        </div>
    </div>
