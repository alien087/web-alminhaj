                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <form action="{{ route('upload_mengaji') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="link_youtube" class="form-control" style="margin-top: 1em;" required>
