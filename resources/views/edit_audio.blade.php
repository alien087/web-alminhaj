            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Murrotal</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <form action="{{ route('update_murrotal', ['id' => $value->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1 class="h5 mb-0 text-gray-800">Judul*</h1>
                                        <input value="{{$value->judul}}" type="text" name="judul" class="form-control" style="margin-top: 1em;" required>

                                        <h1 class="h5 mb-0 text-gray-800" style="margin-top: 1em;">File Murrotal</h1>
                                        <input type="file" name="murrotal" class="form-control" style="margin-top: 1em;" accept="audio/*">
